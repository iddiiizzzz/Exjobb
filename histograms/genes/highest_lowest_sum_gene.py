...
highest_raw_counts = "/storage/koningen/ranked_counts/highest_sum_counts_gene.tsv"
# lowest_raw_counts = "/storage/koningen/ranked_counts/lowest_sum_counts_gene.tsv"
