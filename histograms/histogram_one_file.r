...
# outfile = "histograms/bilder/genes/genes_all/log_transformed_histogram_genes.eps"
outfile = "histograms/bilder/genes/genes_all/sqrt_transformed_histogram_genes.eps"
...
# outfile = "histograms/bilder/genes/one_gene_histograms/highest_mean_count_gene.eps"
# outfile = "histograms/bilder/genes/one_gene_histograms/highest_mean_count_gene_log.eps"
...
ggplot(df, aes(x = values)) +
  geom_histogram(binwidth = 1, fill = "#9b13bb", boundary = 0.5) +
  labs(x = "Count Value", 
       y = "Number of counts") +
  theme_bw() +
  theme(
