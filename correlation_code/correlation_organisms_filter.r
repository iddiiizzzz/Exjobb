...
# results = "/storage/bergid/correlation/results_org_correlation_hg_log75.tsv" #correlation_2
count_matrix = "/storage/bergid/taxonomy_rewrites/taxonomy_all_organisms.tsv"
results = "/storage/bergid/correlation/results_org_correlation_all_log75.tsv"#correlation_3
