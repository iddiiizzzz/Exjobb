...
df <- read.table("/storage/bergid/correlation/results_org_correlation_all_log.tsv", 
...
write.table(df_ordered, file = "/storage/bergid/correlation/results_org_correlation_all_log_ordered.tsv", 
