...
filtered_tax_count_paths = [
    "/storage/koningen/genus/taxonomy_code/filtered_tax_counts_hg.tsv",
    "/storage/koningen/genus/taxonomy_code/filtered_tax_counts_ww1.tsv",
    "/storage/koningen/genus/taxonomy_code/filtered_tax_counts_ww2.tsv"
]
