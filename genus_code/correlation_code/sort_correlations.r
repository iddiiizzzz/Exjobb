...
# file_path <- "/storage/bergid/correlation/genus/both/correlation_zinb_weighted_hg_without_duplicates.tsv"  
...
# file_path <- "/storage/bergid/correlation/genus/both/correlation_filtered_hg_without_duplicates.tsv"
# outfile <- "/storage/bergid/correlation/genus/both/correlation_filtered_hg_sorted.tsv"


# Filtered correlation (normalized)

# file_path <- "/storage/bergid/correlation/genus/both/normalized_correlation_filtered_without_duplicates.tsv"  
