...
file_path <- "/storage/bergid/correlation/both/final_correlation_weighted_normalized.tsv"
outfile <- "/storage/bergid/correlation/both/final_correlation_weighted_normalized_sorted.tsv"
