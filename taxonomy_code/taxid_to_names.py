...
counts_wastewater1 = "test_files/test_kraken.tsv" #"/storage/shared/data_for_master_students/ida_and_ellen/taxonomy_wastewater_1.tsv"
...
output_file_path1 = "/storage/koningen/wastewater1_names.tsv" 
# output_file_path2 = "/storage/koningen/wastewater2_names.tsv"
# output_file_path3 = "/storage/koningen/humangut_names.tsv"
...
taxids1 = header1.split()[1:] # Extracting the whole taxID numbers as one unit
# taxids2 = header2.split() 
# taxids3 = header3.split() 
