...
taxids_with_names = "/storage/koningen/wastewater1_names.tsv" 
bacteria = "/storage/koningen/bacteria.tsv" #"taxonomy_code/taxonomy_outputs/bacteria.tsv"
...
with open(taxids_with_names, "r") as infile, open(bacteria, "w") as outfile:
    for line in infile:
        print(line)
        line = line.strip() 
