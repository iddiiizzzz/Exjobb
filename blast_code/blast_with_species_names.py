...
"""
    Translates the organism IDs to their taxonomic species names and adds them as a new column in the BLAST results table.
...
results = "/storage/bergid/blast/blast_with_species_names.txt"
...
with open(genome_taxonomy, "r") as taxonomy:
    for row in taxonomy:
        ...
        genome_name = row[7] # The species name of the organism
...
blast_results_dataframe["Species_names"] = genome_names
