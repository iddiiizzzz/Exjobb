...
output_files = [
    "/storage/koningen/species/humangut_taxid_to_names.tsv",
    "/storage/koningen/species/wastewater1_taxid_to_names.tsv",
    "/storage/koningen/species/wastewater2_taxid_to_names.tsv"
]
# output_files = [
